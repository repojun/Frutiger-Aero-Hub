export const about = `
The Frutiger Aero Hub is a collection of resources, inspiration, media, and interactive content centered around the Frutiger Aero aesthetic, designed with those glossy, futuristic, sleek features that you'd see back on things like Windows 7/Vista.

It brings everything together into a visually pleasing experience, feel free to use it as a calm checkpoint :)

Experiencing lag? Enable graphics acceleration on your browser!

Special thanks to these goats for testing:
- <a href="https://github.com/cyberlifesami" target="_blank">cyberlifesami</a>
...
export const content = `
  ...
  <div class="examples-grid">
    <img class="example" src="/aero-images/ios.webp" />
    <img class="example" src="/aero-images/vista2.webp" />
    <img class="example" src="/aero-images/vista.webp" />
    <img class="example" src="/aero-images/aero_1.webp" />
    <img class="example" src="/aero-images/aero_17.webp" />
    <img class="example" src="/aero-images/aero_3.webp" />
    <img class="example" src="/aero-images/aero_4.webp" />
    <img class="example" src="/aero-images/aero_5.webp" />
    <img class="example" src="/aero-images/aero_6.webp" />
  </div>
  `;

export const content2 = `# History Of Frutiger Aero
