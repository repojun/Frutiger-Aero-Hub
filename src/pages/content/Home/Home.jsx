  ...
  return (
    <>
      ...
      <div className="main-text-test">
        ...
        <p>
          <span className="welcome-span">Welcome to the Frutiger Aero Hub! </span> This is a new website for Frutiger Aero fans & creators, it contains collections of mini apps to use, resources & archives which you can view in the <span className="tab-span-test">Tabs</span>{" "}
          above. It will also act as a hub for other users to share their own Frutiger Aero projects. Teddy the Aero mascot will guide you through the page {"<3"}
        </p>
      ...
      <div className="button-grid">
        <div className="large-button-test">
