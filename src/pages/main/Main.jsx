...
export default function Main({ children }) {
  ...
  const backgroundArray = [
    { id: 1, imageFile: "/background/hills.webp", icon: "/icons/wallpaper.webp", label: "Hills" },
    { id: 2, imageFile: "/background/aurora.webp", icon: "/icons/wallpaper.webp", label: "Aurora" },
    { id: 12, imageFile: "/background/bliss.webp", icon: "/icons/wallpaper.webp", label: "Bliss" },
    { id: 3, imageFile: "/background/vista.webp", icon: "/icons/wallpaper.webp", label: "Vista" },
    { id: 8, imageFile: "/background/bg3.webp", icon: "/icons/wallpaper.webp", label: "Vista Blue" },
    { id: 7, imageFile: "/background/win7.webp", icon: "/icons/wallpaper.webp", label: "Windows 7" },
    { id: 4, imageFile: "/background/purpleaurora.webp", icon: "/icons/wallpaper.webp", label: "Aurora Purple" },
    { id: 5, imageFile: "/background/greyaurora.webp", icon: "/icons/wallpaper.webp", label: "Aurora Grey" },
    { id: 6, imageFile: "/background/auroraog.webp", icon: "/icons/wallpaper.webp", label: "Aurora Blue" },
